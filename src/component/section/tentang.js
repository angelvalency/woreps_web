...
export default function AboutSection() {
  return (
    <section className="relative flex flex-col font-bold text-xl text-black w-full py-8 md:py-12" id="tentang">
      ...
      <div className="absolute left-0 top-12 md:top-0 w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-[100px] lg:h-[100px]">
        <Image 
      ...
      <div className="absolute top-auto md:-bottom-8 -bottom-2 right-0 w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-[100px] lg:h-[100px]">
        <Image 
